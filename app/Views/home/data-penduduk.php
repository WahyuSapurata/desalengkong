        ...
        <section id="testimonials" class="section-bg wow fadeInUp">
            <div class="container">
                <div class="row">
                    <div class="col-md-9 wow fadeInDown">
                            ...
                            <div class="about-cels pt-0">
                                <div class="p-3">
                                    <table class="text-dark">
                                        ...
                                        <tr>
                                            <td>Total Kelahiran</td>
                                            <td>: <?= $kelahiran ?> Orang</td>
                                            <td> &nbsp; &nbsp; &nbsp; &nbsp;</td>
                                            <td> &nbsp; &nbsp; &nbsp; &nbsp;</td>
                                            <td> &nbsp; &nbsp; &nbsp; &nbsp;</td>
                                            <td> &nbsp; &nbsp; &nbsp; &nbsp;</td>
                                            <td>Total Kematian</td>
                                            <td>: <?= $kematian  ?> Orang</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div class="card" style="color: black;">
                            <div class="card-header">
                                <h5 class="card-title m-0">Tabel Data Pindah Masuk</h5>
                            </div>
                            <div class="card-body">
                                <table id="example16" class="table table-bordered table-hover text-center">
                                    <thead>
                                        <tr>
                                            <th>Nama</th>
                                            <th>Nik</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($masuk as $msk) { ?>
                                            <tr>
                                                ...
                                                <td><?= $msk['tanggal'] ?></td>
                                                <td><?= $msk['alamat'] ?></td>
                                                <td><?= $msk['jenis_kelamin'] ?></td>
                                                <td><?= $msk['tanggal_input'] ?></td>
                                                <td><?= $msk['tanggal_pindah'] ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                        ...
                        <div class="card mt-3" style="color: black;">
                            <div class="card-header">
                                <h5 class="card-title m-0">Tabel Data Pindah Keluar</h5>
                            </div>
                            <div class="card-body">
                                <table id="example17" class="table table-bordered table-hover text-center">
                                    <thead>
                                        <tr>
                                            <th>Nama</th>
                                            <th>Nik</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($keluar as $klr) { ?>
                                            <tr>
                                                ...
                                                <td><?= $klr['tanggal'] ?></td>
                                                <td><?= $klr['alamat'] ?></td>
                                                <td><?= $klr['jenis_kelamin'] ?></td>
                                                <td><?= $klr['tanggal_input'] ?></td>
                                                <td><?= $klr['tanggal_keluar'] ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                        ...
                        <div class="card mt-3" style="color: black;">
                            <div class="card-header">
                                <h5 class="card-title m-0">Tabel Data Dusun Ulurea</h5>
                            </div>

                            <div class="card" style="color: black; margin: 10px;">
                                <div class="card-header" style="background-color: aquamarine;">
                                    <h5 class="card-title m-0">Tabel Data Kelahiran Dusun Ulurea</h5>
                                </div>
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-hover text-center">
                                        ...
                                        <tbody>
                                            <?php foreach ($kelahiran_ulurea as $klh) { ?>
                                                <tr>
                                                    <td><?= $klh['nama'] ?></td>
                                                    <td><?= $klh['tanggal'] ?></td>
                                                    <td><?= $klh['alamat'] ?></td>
                                                    <td><?= $klh['jenis_kelamin'] ?></td>
                                                    <td><?= $klh['tanggal_input'] ?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                            ...
                            <div class="card" style="color: black; margin: 10px;">
                                <div class="card-header" style="background-color: aquamarine;">
                                    <h5 class="card-title m-0">Tabel Data Kematian Dusun Ulurea</h5>
                                </div>
                                <div class="card-body">
                                    <table id="example11" class="table table-bordered table-hover text-center">
                                        <thead>
                                            <tr>
                                                <th>Nama</th>
                                                <th>Nik</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($kematian_ulurea as $klh) { ?>
                                                <tr>
                                                    <td><?= $klh['nama'] ?></td>
                                                    <td><?= $klh['nik'] ?></td>
                                                    <td><?= $klh['tanggal'] ?></td>
                                    ...
                                    <tbody>
                                        <?php foreach ($ulurea as $ulu) { ?>
                                            <tr>
                                                ...
                                                <td><?= $ulu['tanggal'] ?></td>
                                                <td><?= $ulu['alamat'] ?></td>
                                                <td><?= $ulu['jenis_kelamin'] ?></td>
                                                <td><?= $ulu['status'] ?></td>
                                                <td><?= $ulu['pendidikan'] ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                        ...
                        <div class="card mt-3" style="color: black;">
                            <div class="card-header">
                                <h5 class="card-title m-0">Tabel Data Dusun Pakkalolo</h5>
                            </div>

                            <div class="card" style="color: black; margin: 10px;">
                                <div class="card-header" style="background-color: aquamarine;">
                                    <h5 class="card-title m-0">Tabel Data Kelahiran Dusun Pakkalolo</h5>
                                </div>
                                <div class="card-body">
                                    <table id="example7" class="table table-bordered table-hover text-center">
                                        ...
                                        <tbody>
                                            <?php foreach ($kelahiran_pakkalolo as $klh) { ?>
                                                <tr>
                                                    <td><?= $klh['nama'] ?></td>
                                                    <td><?= $klh['tanggal'] ?></td>
                                                    <td><?= $klh['alamat'] ?></td>
                            ...
                            <div class="card" style="color: black; margin: 10px;">
                                <div class="card-header" style="background-color: aquamarine;">
                                    <h5 class="card-title m-0">Tabel Data Kematian Dusun Pakkalolo</h5>
                                </div>
                                <div class="card-body">
                                    <table id="example12" class="table table-bordered table-hover text-center">
                                        <thead>
                                            <tr>
                                                <th>Nama</th>
                                                <th>Nik</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($kematian_pakkalolo as $klh) { ?>
                                                <tr>
                                                    <td><?= $klh['nama'] ?></td>
                                                    <td><?= $klh['nik'] ?></td>
                                                    <td><?= $klh['tanggal'] ?></td>
                        ...
                        <div class="card mt-3" style="color: black;">
                            <div class="card-header">
                                <h5 class="card-title m-0">Tabel Data Dusun Karo</h5>
                            </div>
                            <div class="card" style="color: black; margin: 10px;">
                                <div class="card-header" style="background-color: aquamarine;">
                                    <h5 class="card-title m-0">Tabel Data Kelahiran Dusun Karo</h5>
                                </div>
                                <div class="card-body">
                                    <table id="example8" class="table table-bordered table-hover text-center">
                                        <thead>
                                            <tr>
                                                <th>Nama</th>
                                                <th>Tanggal Lahir</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($kelahiran_karo as $klh) { ?>
                                                <tr>
                                                    <td><?= $klh['nama'] ?></td>
                                                    <td><?= $klh['tanggal'] ?></td>
                                                    <td><?= $klh['alamat'] ?></td>
                            ...
                            <div class="card" style="color: black; margin: 10px;">
                                <div class="card-header" style="background-color: aquamarine;">
                                    <h5 class="card-title m-0">Tabel Data Kematian Dusun Karo</h5>
                                </div>
                                <div class="card-body">
                                    <table id="example13" class="table table-bordered table-hover text-center">
                                        <thead>
                                            <tr>
                                                <th>Nama</th>
                                                <th>Nik</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($kematian_karo as $klh) { ?>
                                                <tr>
                                                    <td><?= $klh['nama'] ?></td>
                                                    <td><?= $klh['nik'] ?></td>
                                                    <td><?= $klh['tanggal'] ?></td>
                        ...
                        <div class="card mt-3" style="color: black;">
                            <div class="card-header">
                                <h5 class="card-title m-0">Tabel Data Dusun Boting</h5>
                            </div>
                            <div class="card" style="color: black; margin: 10px;">
                                <div class="card-header" style="background-color: aquamarine;">
                                    <h5 class="card-title m-0">Tabel Data Kelahiran Dusun Boting</h5>
                                </div>
                                <div class="card-body">
                                    <table id="example9" class="table table-bordered table-hover text-center">
                                        <thead>
                                            <tr>
                                                <th>Nama</th>
                                                <th>Tanggal Lahir</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($kelahiran_boting as $klh) { ?>
                                                <tr>
                                                    <td><?= $klh['nama'] ?></td>
                                                    <td><?= $klh['tanggal'] ?></td>
                                                    <td><?= $klh['alamat'] ?></td>
                            ...
                            <div class="card" style="color: black; margin: 10px;">
                                <div class="card-header" style="background-color: aquamarine;">
                                    <h5 class="card-title m-0">Tabel Data Kematian Dusun Boting</h5>
                                </div>
                                <div class="card-body">
                                    <table id="example14" class="table table-bordered table-hover text-center">
                                        <thead>
                                            <tr>
                                                <th>Nama</th>
                                                <th>Nik</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($kematian_boting as $klh) { ?>
                                                <tr>
                                                    <td><?= $klh['nama'] ?></td>
                                                    <td><?= $klh['nik'] ?></td>
                                                    <td><?= $klh['tanggal'] ?></td>
                                    ...
                                    <tbody>
                                        <?php foreach ($boting as $btg) { ?>
                                            <tr>
                                                ...
                                                <td><?= $btg['tanggal'] ?></td>
                                                <td><?= $btg['alamat'] ?></td>
                                                <td><?= $btg['jenis_kelamin'] ?></td>
                                                <td><?= $btg['status'] ?></td>
                                                <td><?= $btg['pendidikan'] ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                        ...
                        <div class="card mt-3" style="color: black;">
                            <div class="card-header">
                                <h5 class="card-title m-0">Tabel Data Dusun Lengkong</h5>
                            </div>
                            <div class="card" style="color: black; margin: 10px;">
                                <div class="card-header" style="background-color: aquamarine;">
                                    <h5 class="card-title m-0">Tabel Data Kelahiran Dusun Lengkong</h5>
                                </div>
                                <div class="card-body">
                                    <table id="example10" class="table table-bordered table-hover text-center">
                                        <thead>
                                            <tr>
                                                <th>Nama</th>
                                                <th>Tanggal Lahir</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($kelahiran_lengkong as $klh) { ?>
                                                <tr>
                                                    <td><?= $klh['nama'] ?></td>
                                                    <td><?= $klh['tanggal'] ?></td>
                                                    <td><?= $klh['alamat'] ?></td>
                            ...
                            <div class="card" style="color: black; margin: 10px;">
                                <div class="card-header" style="background-color: aquamarine;">
                                    <h5 class="card-title m-0">Tabel Data Kematian Dusun Lengkong</h5>
                                </div>
                                <div class="card-body">
                                    <table id="example15" class="table table-bordered table-hover text-center">
                                        <thead>
                                            <tr>
                                                <th>Nama</th>
                                                <th>Nik</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($kematian_lengkong as $klh) { ?>
                                                <tr>
                                                    <td><?= $klh['nama'] ?></td>
                                                    <td><?= $klh['nik'] ?></td>
                                                    <td><?= $klh['tanggal'] ?></td>
                                    ...
                                    <tbody>
                                        <?php foreach ($lengkong as $lkg) { ?>
                                            <tr>
                                                ...
                                                <td><?= $lkg['tanggal'] ?></td>
                                                <td><?= $lkg['alamat'] ?></td>
                                                <td><?= $lkg['jenis_kelamin'] ?></td>
                                                <td><?= $lkg['status'] ?></td>
                                                <td><?= $lkg['pendidikan'] ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                    ...
                    <div class="col-md-3" style="border-left: 2px solid; width:auto;">
                        <div class="about-col bg-success" style="height: auto;">
                            <div class="about-cels pt-0">
                                <header class="section-header">
