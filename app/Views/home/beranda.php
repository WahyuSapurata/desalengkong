        ...
        <section id="intro" style="height: auto;">
            <div class="slider">
                <div class="background-video">
                    <img src="<?= base_url() ?>/img/lengkong1.jpg" class="video-fluid d-inline-block" alt="">
                </div>
                <div class="background-video">
                    <img src="<?= base_url() ?>/img/lengkong2.jpg" class="video-fluid d-inline-block" alt="">
                </div>
                <div class="background-video">
                    <img src="<?= base_url() ?>/img/lengkong3.jpg" class="video-fluid d-inline-block" alt="">
                </div>
            </div>
        </section><!-- #intro -->
    </section>
      ...
      ============================-->
        <section id="testimonials" class="section-bg wow fadeInUp">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h3 class="info">Artikel</h3>
                        <?php
                        foreach ($artikel as $atk) { ?>
                            <h4 class="judul-artikel"><?= $atk['judul'] ?></h4>
                            <div class="your-class mt-3">
                                <div>
                                    <img src="<?= base_url('uploads/artikel/' . $atk['foto']) ?>" class="img-artikel d-inline-block" alt="">
                                </div>
                            </div>
                            <div class="post_content_w mt-3">
                                <div class="post_sw">
                                    <div class="post_w">
                                        <div class="post_s">
                                            <ul class="single_post_share_icon_post">
                                                <li class="post-facebook">
                                                    <a href="http://www.facebook.com/sharer.php?u=https://banii.id" target="_blank" style="color: #3b5998;"><i class="fab fa-facebook"></i></a>
                                                </li>
                                                <li class="post-facebook">
                                                    <a href="https://twitter.com/share?url=https://banii.id" style="color: #1da1f2;"><i class="fab fa-twitter"></i></i></a>
                                                </li>
                                                <li class="post-facebook">
                                                    <a href="https://api.whatsapp.com/send?phone=&text=https://banii.id" style="color: #25d366;"><i class="fab fa-whatsapp"></i></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="post_content jl_content">
                                    <h6  class="text-content-artikel" style="color: black;"><?= $atk['isi'] ?></h6>
                                    <hr class="bg-dark">
                                    <small>Editor : <b style="color: darkcyan;">desa lengkong</b> <i class="fas fa-user-edit"></i></small>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
        ...
        <section id="about">
            <div class="container">
                <header class="section-header">
                    <h6>Galeri Lengkong</h6>
                </header>
                <?php foreach ($kegiatan as $dkm) { ?>
                    <div class="dokumentasi-lengkong">
                        <a href="<?= base_url('home/detail_galery/' . $dkm['id_kegiatan']) ?>">
                            <img src="<?= base_url('img/folder.png') ?>" style="width: 10vw; height: 20vh; border-radius: 5px;" alt="">
                            <h6 class="dokumentasi-text"><?= $dkm['nama_kegiatan'] ?></h6>
                        </a>
                    </div>
                <?php } ?>
            </div>
