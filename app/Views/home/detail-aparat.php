                    ...
                    <div class="col-md-7 wow fadeInDown">
                        <?php foreach ($aparat as $apr) { ?>
                            <header class="section-header">
                                <h6>Detail <?= $apr['jabatan'] ?></h6>
                            </header>
                            <div class="text-detail-desa">
                                <img src="<?= base_url('uploads/' . $apr['foto']) ?>" class="img-fluid" alt="">
                                <table style="display: inline-block; margin-left: 10px;">
                                    <tr>
                                        <th>Nama Lengkap</th>
                                        <th>: <?= $apr['nama_lengkap'] ?></th>
                                    </tr>
                                    <tr>
                                        <th>Nama Panggilan</th>
                                        <th>: <?= $apr['nama_panggilan'] ?></th>
                                    </tr>
                                    <tr>
                                        <th>Jabatan</th>
                                        <th>: <?= $apr['jabatan'] ?></th>
                                    ...
                                    <tr>
                                        <th><a target="_blank" href="https://www.google.com/maps/place/<?= $apr['lokasi'] ?>" class="btn btn-primary mt-2">Lokasi <i class="fa-solid fa-paper-plane"></i></a></th>
                                    </tr>
                                </table>
                            </div>
                        <?php } ?>
