                    ...
                    <div class="col-md-7 wow fadeInDown">
                        <?php foreach ($lokasi as $lks) { ?>
                            <header class="section-header">
                                <h6>Detail <?= $lks['nama_lokasi'] ?></h6>
                            </header>
                            <div class="text-detail-desa">
                                <img src="<?= base_url('uploads/lokasi/' . $lks['foto']) ?>" class="img-fluid" alt="">
                                <table style="display: inline-block; margin-left: 10px;">
                                    <tr>
                                        <th>Nama Tempat</th>
                                        <th>: <?= $lks['nama_lokasi'] ?></th>
                                    </tr>
                                    <tr>
                                        <th><a target="_blank" href="https://www.google.com/maps/place/<?= $lks['lokasi'] ?>" class="btn btn-primary mt-2">Lokasi <i class="fa-solid fa-paper-plane"></i></a></th>
                                    </tr>
                                </table>
                            </div>
                        <?php } ?>
