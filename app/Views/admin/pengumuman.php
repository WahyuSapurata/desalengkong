            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/pengumuman') ?>" class="nav-link active">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="alert" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fa-solid fa-bullhorn"></i> Pengumuman</h3>
                    </div>

                    <div class="card" style="margin-bottom: 70px;">
                        <div class="card-header">
                            <h5 class="card-title m-0">Tabel Pengumuman</h5>
                                ...
                                <?php $no = 1;
                                    foreach ($pengumuman as $pgm) { ?>
                                        <tr>
                                            ...
                                            <td><?= $pgm['isi'] ?></td>
                                            <td>
                                                <form action="<?= base_url() ?>/admin/hapus_pengumuman/<?= $pgm['id_pengumuman'] ?>" method="post">
                                                    <button type="button" class="badge badge-warning" style="border: none; margin-right: 10px;" data-toggle="modal" data-target="#edit_modal<?= $pgm['id_pengumuman'] ?>">
                                        ...
                                        <div class="modal fade" id="edit_modal<?= $pgm['id_pengumuman'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/edit_pengumuman/' . $pgm['id_pengumuman']) ?>">
                                                            <?= csrf_field(); ?>
                                                            <div class="form-group">
                                                                <label>Isi Pengumuman</label>
                                                                <input type="text" name="isi" class="form-control" value="<?= $pgm['isi'] ?>" required>
                                                            </div>
