            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/kelahiran') ?>" class="nav-link active">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="alert" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fa-solid fa-person"></i> Data Kelahiran</h3>
                    </div>

                    <div class="card" style="margin-bottom: 70px;">
                        <div class="card-header">
                            <h5 class="card-title m-0">Tabel Data Kelahiran</h5>
                                ...
                                <tbody>
                                    ...
                                    foreach ($kelahiran as $klh) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="<?= base_url() ?>/admin/hapus_kelahiran/<?= $klh['id_kelahiran'] ?>" method="post">
                                                    <button type="button" class="badge badge-warning" style="border: none; margin-right: 10px;" data-toggle="modal" data-target="#edit_modal<?= $klh['id_kelahiran'] ?>">
                                        ...
                                        <div class="modal fade" id="edit_modal<?= $klh['id_kelahiran'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="myModalLabel">Edit Data Kelahiran</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="POST" action="<?= base_url('admin/edit_kelahiran/' . $klh['id_kelahiran']) ?>">
                                                            <?= csrf_field(); ?>
                                                            <div class="form-group">
                                                                <label>Nama</label>
                                                                <input type="text" name="nama" value="<?= $klh['nama'] ?>" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Tanggal Lahir</label>
                                                                <input type="date" name="tanggal" value="<?= $klh['tanggal'] ?>" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Alamat</label>
                                                                <select name="alamat" class="form-control" required>
                                                                    <option>-- Pilih --</option>
                                                                    <option value="Ulurea" <?= $klh['alamat'] == "Ulurea" ? 'selected' : "" ?>>Ulurea</option>
                                                                    <option value="Pakkalolo" <?= $klh['alamat'] == "Pakkalolo" ? 'selected' : "" ?>>Pakkalolo</option>
                                                                    <option value="Karo" <?= $klh['alamat'] == "Karo" ? 'selected' : "" ?>>Karo</option>
                                                                    <option value="Boting" <?= $klh['alamat'] == "Boting" ? 'selected' : "" ?>>Boting</option>
                                                                    <option value="Lengkong" <?= $klh['alamat'] == "Lengkong" ? 'selected' : "" ?>>Lengkong</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Jenis Kelamin</label><br>
                                                                <input type="radio" name="jenis_kelamin" required value="Laki-laki" <?= $klh['jenis_kelamin'] == "Laki-laki" ? 'checked' : "" ?>> Laki-laki<br>
                                                                <input type="radio" name="jenis_kelamin" required value="Perempuan" <?= $klh['jenis_kelamin'] == "Perempuan" ? 'checked' : "" ?>> Perempuan<br>
                                                            </div>
