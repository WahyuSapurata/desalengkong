            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/dokumentasi') ?>" class="nav-link active">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="alert" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fas fa-images nav-icon"></i> Dokumentasi</h3>
                    </div>

                    <div class="card" style="margin-bottom: 70px;">
                        <div class="card-header">
                            <h5 class="card-title m-0">Tabel Dokumentasi</h5>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-hover text-center">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                    foreach ($join_dokumentasi as $dkm) { ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            <td><?= $dkm['nama_kegiatan'] ?></td>
                                            <td><img src="<?= base_url('uploads/dokumentasi/' . $dkm['foto']) ?>" width="100" alt=""></td>
                                            <td>
                                                <form action="<?= base_url() ?>/admin/hapus_dokumentasi/<?= $dkm['id_dokumentasi'] ?>" method="post">
                                                    <button type="button" class="badge badge-warning" style="border: none; margin-right: 10px;" data-toggle="modal" data-target="#edit_modal<?= $dkm['id_dokumentasi'] ?>">
                                        ...
                                        <div class="modal fade" id="edit_modal<?= $dkm['id_dokumentasi'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="myModalLabel">Edit Dokumentasi</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/edit_dokumentasi/' . $dkm['id_dokumentasi']) ?>">
                                                            <?= csrf_field(); ?>
                                                            <input type="hidden" name="lama" value="<?= $dkm['foto'] ?>">
                                                            <div class="form-group">
                                                                <label>Nama Kegiatan</label>
                                                                <select name="id_kegiatan" id="id_kegiatan" class="form-control">
                                                                    <option value="">--pilih kegiatan--</option>
                                                                    <?php foreach ($kegiatan as $kgt) : ?>
                                                                        <option value="<?= $kgt['id_kegiatan']; ?>" <?php if ($kgt['id_kegiatan'] == $dkm['id_kegiatan']) : ?> selected <?php endif ?>><?= $kgt['nama_kegiatan']; ?></option>
                                                                    <?php endforeach ?>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <img src="<?= base_url('uploads/dokumentasi/' . $dkm['foto']) ?>" width="100" alt="" class="mb-3 img-preview">
