            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/lokasi') ?>" class="nav-link active">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="alert" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fa-solid fa-location-dot"></i> Data Lokasi</h3>
                    </div>

                    <div class="card" style="margin-bottom: 70px;">
                        <div class="card-header">
                            <h5 class="card-title m-0">Tabel Data Lokasi</h5>
                                ...
                                <?php $no = 1;
                                    foreach ($lokasi as $lks) { ?>
                                        <tr>
                                            ...
                                            <td><?= $lks['lokasi'] ?></td>
                                            <td><img src="<?= base_url('uploads/lokasi/' . $lks['foto']) ?>" width="100" alt=""></td>
                                            <td>
                                                <form action="<?= base_url() ?>/admin/hapus_lokasi/<?= $lks['id_lokasi'] ?>" method="post">
                                                    <button type="button" class="badge badge-warning" style="border: none; margin-right: 10px;" data-toggle="modal" data-target="#edit_modal<?= $lks['id_lokasi'] ?>">
                                        ...
                                        <div class="modal fade" id="edit_modal<?= $lks['id_lokasi'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/edit_lokasi/' . $lks['id_lokasi']) ?>">
                                                            <?= csrf_field(); ?>
                                                            <input type="hidden" name="lama" value="<?= $lks['foto'] ?>">
                                                            <div class="form-group">
                                                                <label>Nama Kegiatan</label>
                                                                <input type="text" name="nama_lokasi" class="form-control" value="<?= $lks['nama_lokasi'] ?>" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Lokasi</label>
                                                                <input type="text" name="lokasi" class="form-control" value="<?= $lks['lokasi'] ?>" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Foto</label>
                                                                <input type="file" id="file_upload" class="custom" name="file_upload" onchange="previewimg()">
                                                            </div>
                                                            <img src="<?= base_url('uploads/lokasi/' . $lks['foto']) ?>" width="100" alt="" class="mb-3 img-preview">
