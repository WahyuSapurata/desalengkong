            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/kegiatan') ?>" class="nav-link active">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="alert" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fa-solid fa-hot-tub-person"></i> Kegiatan</h3>
                    </div>

                    <div class="card" style="margin-bottom: 70px;">
                        <div class="card-header">
                            <h5 class="card-title m-0">Tabel Kegiatan</h5>
                                ...
                                <tbody>
                                    ...
                                    foreach ($kegiatan as $kgt) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="<?= base_url() ?>/admin/hapus_kegiatan/<?= $kgt['id_kegiatan'] ?>" method="post">
                                                    <button type="button" class="badge badge-warning" style="border: none; margin-right: 10px;" data-toggle="modal" data-target="#edit_modal<?= $kgt['id_kegiatan'] ?>">
                                        ...
                                        <div class="modal fade" id="edit_modal<?= $kgt['id_kegiatan'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="<?= base_url('admin/edit_kegiatan/' . $kgt['id_kegiatan']) ?>">
                                                            <?= csrf_field(); ?>
                                                            <div class="form-group">
                                                                <label>Nama Kegiatan</label>
                                                                <input type="text" name="nama_kegiatan" class="form-control" value="<?= $kgt['nama_kegiatan'] ?>" required>
                                                            </div>
