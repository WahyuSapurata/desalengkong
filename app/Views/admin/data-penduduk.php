            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/penduduk') ?>" class="nav-link active">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="alert" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fa-solid fa-id-card"></i> Data Penduduk</h3>
                    </div>

                    <div class="card" style="margin-bottom: 70px;">
                        <div class="card-header">
                            <h5 class="card-title m-0">Tabel Data Penduduk</h5>
                                ...
                                <tbody>
                                    ...
                                    foreach ($penduduk as $pdk) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="<?= base_url() ?>/admin/hapus_penduduk/<?= $pdk['id_penduduk'] ?>" method="post">
                                                    <button type="button" class="badge badge-warning" style="border: none; margin-right: 10px;" data-toggle="modal" data-target="#edit_modal<?= $pdk['id_penduduk'] ?>">
                                        ...
                                        <div class="modal fade" id="edit_modal<?= $pdk['id_penduduk'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="<?= base_url('admin/edit_penduduk/' . $pdk['id_penduduk']) ?>">
                                                            <?= csrf_field(); ?>
                                                            <div class="form-group">
                                                                <label>Nama</label>
                                                                <input type="text" name="nama" value="<?= $pdk['nama'] ?>" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Nik</label>
                                                                <input type="text" name="nik" value="<?= $pdk['nik'] ?>" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>No KK</label>
                                                                <input type="text" name="no_kk" value="<?= $pdk['no_kk'] ?>" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Tanggal Lahir</label>
                                                                <input type="date" name="tanggal" value="<?= $pdk['tanggal'] ?>" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Alamat</label>
                                                                <select name="alamat" class="form-control" required>
                                                                    <option>-- Pilih --</option>
                                                                    <option value="Ulurea" <?= $pdk['alamat'] == "Ulurea" ? 'selected' : "" ?>>Ulurea</option>
                                                                    <option value="Pakkalolo" <?= $pdk['alamat'] == "Pakkalolo" ? 'selected' : "" ?>>Pakkalolo</option>
                                                                    <option value="Karo" <?= $pdk['alamat'] == "Karo" ? 'selected' : "" ?>>Karo</option>
                                                                    <option value="Boting" <?= $pdk['alamat'] == "Boting" ? 'selected' : "" ?>>Boting</option>
                                                                    <option value="Lengkong" <?= $pdk['alamat'] == "Lengkong" ? 'selected' : "" ?>>Lengkong</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Jenis Kelamin</label><br>
                                                                <input type="radio" name="jenis_kelamin" required value="Laki-laki" <?= $pdk['jenis_kelamin'] == "Laki-laki" ? 'checked' : "" ?>> Laki-laki<br>
                                                                <input type="radio" name="jenis_kelamin" required value="Perempuan" <?= $pdk['jenis_kelamin'] == "Perempuan" ? 'checked' : "" ?>> Perempuan<br>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Status</label>
                                                                <select name="status" class="form-control" required>
                                                                    <option>-- Pilih --</option>
                                                                    <option value="Kawin" <?= $pdk['status'] == "Kawin" ? 'selected' : "" ?>>Kawin</option>
                                                                    <option value="Belum kawin" <?= $pdk['status'] == "Belum kawin" ? 'selected' : "" ?>>Belum kawin</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Pendidikan</label>
                                                                <input type="text" name="pendidikan" value="<?= $pdk['pendidikan'] ?>" class="form-control" required>
                                                            </div>
