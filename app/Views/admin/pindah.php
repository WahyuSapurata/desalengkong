            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/aparat_desa') ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/pindah') ?>" class="nav-link active">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="alert" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fa-solid fa-person-booth"></i> Data Pindah Masuk</h3>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($pindah as $pdh) { ?>
                                        <tr>
                                            ...
                                            <td><?= $pdh['tanggal'] ?></td>
                                            <td><?= $pdh['alamat'] ?></td>
                                            <td><?= $pdh['jenis_kelamin'] ?></td>
                                            <td><?= $pdh['tanggal_input'] ?></td>
                                            <td><?= $pdh['tanggal_pindah'] ?></td>
                                            <td>
                                                <form action="<?= base_url() ?>/admin/hapus_pindah/<?= $pdh['id_pindah'] ?>" method="post">
                                                    <button type="button" class="badge badge-warning" style="border: none; margin-right: 10px;" data-toggle="modal" data-target="#edit_modal<?= $pdh['id_pindah'] ?>">
                                        ...
                                        <div class="modal fade" id="edit_modal<?= $pdh['id_pindah'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="myModalLabel">Edit Pindah Masuk</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="POST" action="<?= base_url('admin/edit_pindah/' . $pdh['id_pindah']) ?>">
                                                            <?= csrf_field(); ?>
                                                            <div class="form-group">
                                                                <label>Nama</label>
                                                                <input type="text" name="nama" value="<?= $pdh['nama'] ?>" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Nik</label>
                                                                <input type="text" name="nik" value="<?= $pdh['nik'] ?>" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>No KK</label>
                                                                <input type="text" name="no_kk" value="<?= $pdh['no_kk'] ?>" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Tanggal Lahir</label>
                                                                <input type="date" name="tanggal" value="<?= $pdh['tanggal'] ?>" class="form-control" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Alamat</label>
                                                                <select name="alamat" class="form-control" required>
                                                                    <option>-- Pilih --</option>
                                                                    <option value="Ulurea" <?= $pdh['alamat'] == "Ulurea" ? 'selected' : "" ?>>Ulurea</option>
                                                                    <option value="Pakkalolo" <?= $pdh['alamat'] == "Pakkalolo" ? 'selected' : "" ?>>Pakkalolo</option>
                                                                    <option value="Karo" <?= $pdh['alamat'] == "Karo" ? 'selected' : "" ?>>Karo</option>
                                                                    <option value="Boting" <?= $pdh['alamat'] == "Boting" ? 'selected' : "" ?>>Boting</option>
                                                                    <option value="Lengkong" <?= $pdh['alamat'] == "Lengkong" ? 'selected' : "" ?>>Lengkong</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Jenis Kelamin</label><br>
                                                                <input type="radio" name="jenis_kelamin" required value="Laki-laki" <?= $pdh['jenis_kelamin'] == "Laki-laki" ? 'checked' : "" ?>> Laki-laki<br>
                                                                <input type="radio" name="jenis_kelamin" required value="Perempuan" <?= $pdh['jenis_kelamin'] == "Perempuan" ? 'checked' : "" ?>> Perempuan<br>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Tanggal Pindah Masuk</label>
                                                                <input type="date" name="tanggal_pindah" value="<?= $pdh['tanggal_pindah'] ?>" class="form-control" required>
                                                            </div>
