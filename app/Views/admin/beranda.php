    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="<?= base_url() ?>/img/logo1.png" alt="Bani Logo" class="brand-image img-circle elevation-3">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="alert" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fas fa-tachometer-alt"></i> Dasboard</h3>
                    </div>
                    <div class="card">
                        <div class="card-header text-center">
                            <h1><b>Selamat Datang <?= session('username') ?></b></h1>
                        </div>
                        <div class="card-body">
                            <div class="row d-block text-center">
                                <h2>WEBSITE DESA LENGKONG <br> KACAMATAN BUA KABUPETEN LUWU</h2>
                            </div>
                        </div>
                    </div>
                    <!-- /.row -->
