            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/artikel_desa') ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/artikel') ?>" class="nav-link active">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="alert" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fa-solid fa-newspaper"></i> Data Artikel</h3>
                    </div>

                    <div class="card" style="margin-bottom: 70px;">
                        <div class="card-header">
                            <h5 class="card-title m-0">Tabel Data Artikel</h5>
                                ...
                                <tbody>
                                    ...
                                    foreach ($artikel as $atk) { ?>
                                        <tr>
                                            ...
                                            <td><?= $atk['judul'] ?></td>
                                            <td><?= $atk['isi'] ?></td>
                                            <td><img src="<?= base_url('uploads/artikel/' . $atk['foto']) ?>" width="100" alt=""></td>
                                            <td>
                                                <form action="<?= base_url() ?>/admin/hapus_artikel/<?= $atk['id_artikel'] ?>" method="post">
                                                    <button type="button" class="badge badge-warning" style="border: none; margin-right: 10px;" data-toggle="modal" data-target="#edit_modal<?= $atk['id_artikel'] ?>">
                                        ...
                                        <div class="modal fade" id="edit_modal<?= $atk['id_artikel'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/edit_artikel/' . $atk['id_artikel']) ?>">
                                                            <?= csrf_field(); ?>
                                                            <input type="hidden" name="lama" value="<?= $atk['foto'] ?>">
                                                            <div class="form-group">
                                                                <label>Judul</label>
                                                                <input type="text" name="judul" class="form-control" value="<?= $atk['judul'] ?>" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Isi Artikel</label>
                                                                <textarea type="text" name="isi" id="ckeditor" class="ckeditor" value="<?= $atk['isi'] ?>" required style="width: auto;"><?= $atk['isi'] ?> </textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Foto</label>
                                                                <input type="file" id="file_upload" class="custom" name="file_upload" onchange="previewimg()">
                                                            </div>
                                                            <img src="<?= base_url('uploads/artikel/' . $atk['foto']) ?>" width="100" alt="" class="mb-3 img-preview">
